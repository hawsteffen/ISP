...
bew_farbe_constr(_,blau) :- !,fail.
bew_farbe_constr(brite,_) :- !,fail.
bew_farbe_constr(norweger,_) :- !,fail.
bew_farbe_constr(_,_):- true.

% 2
bew_tier_constr(schwede,hund).
bew_tier_constr(schwede,_) :- !, fail.
bew_tier_constr(_,hund) :- !, fail.
bew_tier_constr(_,_) :- true.

% 3
bew_getraenk_constr(daene,tee).
bew_getraenk_constr(_,tee) :- !, fail.
bew_getraenk_constr(daene,_) :- !, fail.
...
tier_zigaretten_constr(vogel,_) :- !, fail.
...
getraenk_zigaretten_constr(bier,_) :- !, fail.
...
bewohner_zigaretten_constr(deutscher,_) :- !, fail.
