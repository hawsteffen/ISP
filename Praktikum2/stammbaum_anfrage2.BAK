...
stammbaum_fragen([Funktor,Arg1,Arg2,Arg3]) :- var(Arg1), var(Arg2), Struktur =.. [Funktor,Arg1,Arg2,Arg3], call(Struktur),!, writeln(Arg1),writeln(Arg2).
...
% Verarbeitung der Wer-sind-Frage
